                                  ...
                                  <div class="mega-menu-content style-2 clearfix">
                                      <ul class="mega-menu-column col-md-3">
                                          <li class=mega-menu-title>
                                              ...
                                              <ul itemscope itemtype=https://www.schema.org/SiteNavigationElement>
                                                  <li itemprop=name>
                                                      <a itemprop=url href=/hotel/manage-reservation>
                                                          <div>Manage Reservation</div>
                                                      </a>
                                                  <li itemprop=name>
                                                      <a itemprop=url href=http://support.reservations.com target=_blank>
                                                          <div>Customer Support</div>
                                                      </a><li itemprop=name>
                                                  <a itemprop=url href=http://support.reservations.com/knowledgebase target=_blank><div>Knowledge Base</div>
                                                  </a>
                                                  <li itemprop=name>
                                                      <a itemprop=url href=http://groups.reservations.com target=_blank>
                                                          <div>Group Hotels</div>
                                                      </a>
                                                  <li itemprop=name>
                                                      <a itemprop=url href=/deals>
                                                          <div>Deals & Discounts</div>
                                                      </a>
                                                  <li itemprop=name>
                                                      <a itemprop=url href=/mobile>
                                                          <div>Mobile</div></a>
                                                  <li itemprop=name>
                                                  ...
                                                  <li itemprop=name>
                                                      <a itemprop=url href=/hotels/continents>
                                                          <div>Sitemap</div>
                                                      </a>
                                              </ul>
                                      </ul>
                                      <ul class="mega-menu-column col-md-3">
                                          <li class=mega-menu-title>
                                              ...
                                              <ul itemscope itemtype=http://www.schema.org/SiteNavigationElement>
                                                  <li itemprop=name>
                                                      <a itemprop=url href=/car-rentals target=_blank>
                                                          <div>Car Rentals</div>
                                                      </a>
                                                  <li itemprop=name>
                                                      <a itemprop=url href="http://groups.reservations.com/Rental-Car-Reservations/" target=_blank>
                                                          <div>Group Car Rentals</div>
                                                      </a>
                                              </ul>
                                      </ul>
                                      <ul class="mega-menu-column col-md-3">
                                          <li class=mega-menu-title>
                                              ...
                                              <ul itemscope itemtype=http://www.schema.org/SiteNavigationElement>
                                                  <li itemprop=name><a itemprop=url href=/about>
                                                      <div>About Us</div>
                                                      </a>
                                                  <li itemprop=name>
                                                      <a itemprop=url href=/about#culture><div>Corporate Culture</div>
                                                      </a>
                                                  <li itemprop=name>
                                                  ...
                                                  <li itemprop=name>
                                                      <a itemprop=url href=/investors>
                                                          <div>Investor Relations</div>
                                                      </a>
                                                  <li itemprop=name>
                                                      <a itemprop=url href=/partnerships>
                                      ...
                                      <ul class="mega-menu-column col-md-3">
                                          <li class=mega-menu-title>
                                              ...
                                              <ul itemscope itemtype=http://www.schema.org/SiteNavigationElement>
                                                  <li itemprop=name>
                                                      <a itemprop=url href=http://blog.reservations.com target=_blank>
                                                          <div>Runaway Suitcase Blog</div>
                                                      </a>
                                                  <li itemprop=name>
                                                      <a itemprop=url href=http://givingatreservations.com target=_blank>
                                                          <div>Giving at Reservations.com</div>
                                                      </a>
                                                  <li itemprop=name>
            ...
            <div style="margin-left:25%">
              ...
              for(int i = 0; i< allHotels.size();i++){
                ...
                oneHotel = allHotels.get(i);%>
                  ...
                  <tr><td>
                    <tr><td><h4>Name : <% out.println(oneHotel.get(1)); %></h4></td></tr>
                  <tr><td><h4>City : <% out.println(oneHotel.get(2)); %></h4></td></tr>
                  <tr><td><h4>State : <% out.println(oneHotel.get(4)); %></h4></td></tr></td>
                  <td><% out.println("<img src ='"+ oneHotel.get(4) +"' height='150' width='150'");%></td></tr>
              <% } %>
              </table></td></tr>
            </table>
            </div>
